...
<div class="row">
  ...
  <label for="uname"><b>Name of Society/Locality</b></label>
    <input type="text" class="form-control" placeholder="Enter Locality" name="Locality" required>
</div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" placeholder="Enter number" name="Bedrooms" min=0 max=100 required>
</div> <div class="form-group">
...
<textarea name="Description" id="" class="form-control" cols="10" rows="2" placeholder="Description"></textarea>
    ...
    <button type="submit" name="login"  class="button" value="Submit">Submit</button>
        </div>
